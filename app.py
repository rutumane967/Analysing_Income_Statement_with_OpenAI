        ...
        try:
            ...
            try:
                with open(st.session_state.temp_filename, "rb") as f:
                    ...
                    preview_tab, info_tab = st.tabs(["📄 Preview", "📄 Document Info"])
                ...
                st.markdown(f'<div class="error">📄 Error previewing PDF: {str(e)}</div>', unsafe_allow_html=True)
            ...
            with st.spinner("📄 Extracting tables from PDF..."):
                try:
                    ...
                    st.markdown(f'<div class="error">📄 Error extracting tables: {e}</div>', unsafe_allow_html=True)
                    return
            ...
            if dfs:
                ...
                st.markdown('<div class="warning">📄 No tables found in the uploaded PDF.</div>', unsafe_allow_html=True)
...
=======
                # llm_pipeline = initialize_llm_pipeline()
>>>>>>> 57cb7ef908424408558d0e2ea420ba23eda35c8e
                # Summarization
                ...
                try:
                    ...
                    st.markdown(f'<div class="error">📄 Error during summarization: {e}</div>', unsafe_allow_html=True)
            st.markdown('</div>', unsafe_allow_html=True)
            ...
            if st.session_state.temp_filename and os.path.exists(st.session_state.temp_filename):
                try:
                    ...
                    st.warning(f"📄 Could not delete temporary file: {e}. The file will be cleaned up in the next session.")
